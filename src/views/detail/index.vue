...
import ImageView from "@/components/imgaeview/index.vue";
    ...
    <div class="container" v-if="good.details">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/category/subcategory/${good.categories[0].id}` }"
        ...
        <div>
          <div class="goods-info">
            ...
            <div class="spec">
              ...
              <!-- sku组件 -->
              <XtxGoodSku :goods="good" @change="skuchange" />
              <!-- 数据组件 -->
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                  <img v-for="pic in good.details.pictures" :src="pic" :key="pic" />
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
